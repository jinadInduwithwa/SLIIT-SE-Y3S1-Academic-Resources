...
public class TestReportProducerIMP implements TestReportProducer {
	...
	private String[][] exhistingTestReports = {
			{"1","Sugar Test","Kasun Tharaka","6.8%","You have Diabetes","11/03/2025"},
			{"2","Lipid Test","Bimal Kavinda","150 mg/dL","Your test result is normal","15/02/2025"},
			{"3","Creatinine Test","Mahinda Peries","1.85 mg/dL","You have to take prevoius medicine","07/01/2025"},
			{"4","Urine Test","Namal Mihiran","4.1 hpf","You have to drink more water","18/01/2025"},
			{"5","Antigen Test","Ranil Chaminda","Positive","You have to self quarantine immediately","25/02/2025"}
			};
